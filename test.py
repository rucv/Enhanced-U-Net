...
def test():
    ...
    with torch.no_grad():
        ...
        for i, data in bar:
            ...
            _ACC_overall, _IoU_poly, _IoU_bg, _IoU_mean, _Dice = evaluate(output, gt)
    ...
    print('recall: %.4f, specificity: %.4f, precision: %.4f, F1: %.4f, F2: %.4f, '
          ...
          % (metrics_result['recall'], metrics_result['specificity'], metrics_result['precision'],
             ...
             metrics_result['IoU_poly'], metrics_result['IoU_bg'], metrics_result['IoU_mean'], metric_result['Dice']))
